...
import { BigintIsh, CurrencyAmount, Percent, Price, sqrt, Token } from '../core'
...
export class Pair {
  ...
  public constructor(currencyAmountA: CurrencyAmount<Token>, tokenAmountB: CurrencyAmount<Token>, pairAddress: string) {
   ...
   * https://ethereum.stackexchange.com/questions/101629/what-is-math-for-VaraSwap-calculates-the-amountout-and-amountin-why-997-and-1000
  ...
  public getOutputAmount(
    ...
    return [
      ...
      new Pair(inputReserve.add(inputAmountAfterTax), outputReserve.subtract(outputAmountAfterTax), this.liquidityToken.address),
    ]
  }
  ...
  public getInputAmount(
    ...
    const inputAmountBeforeTax = percentAfterSellFees.greaterThan(ZERO_PERCENT)
      ...
      : inputAmount
    return [inputAmountBeforeTax, new Pair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount), this.liquidityToken.address)]
  }
